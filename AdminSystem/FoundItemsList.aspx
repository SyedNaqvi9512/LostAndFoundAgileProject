        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnEdit" runat="server" Text="Edit" OnClick="btnEdit_Click" CssClass="button-spacing button-color" />
            ...
            <tr>
                <td>
                    <asp:ListBox ID="lstFoundItemsList" runat="server" Rows="15" Width="400px"></asp:ListBox>
                </td>
            </tr>
            <tr>
                <td>
